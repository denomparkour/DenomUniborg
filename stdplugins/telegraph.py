    ...
    if event.reply_to_msg_id:
        ...
        if input_str == "media":
            ...
            try:
                ...
                os.remove(downloaded_file_name)
                await event.edit("Graphed to (Telegraph!)[https://www.telegra.ph{}] in {} seconds.".format(media_urls[0], (ms + ms_two)), link_preview=True)
        elif input_str == "text":
            ...
            ms = (end - start).seconds
            await event.edit("Graphed to (Telegraph!)[https://https://www.telegra.ph{}] in {} seconds.".format(response["path"], ms), link_preview=True)
    else:
