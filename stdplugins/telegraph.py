    ...
    if event.reply_to_msg_id:
        ...
        if input_str == "media":
            ...
            try:
                ...
                os.remove(downloaded_file_name)
                await event.edit("Graphed to Telegraph!{} in {} seconds.".format(media_urls[0], (ms + ms_two)), link_preview=True)
        elif input_str == "text":
            ...
            ms = (end - start).seconds
            await event.edit("Graphed to telegraph{} in {} seconds.".format(response["path"], ms), link_preview=True)
    else:
